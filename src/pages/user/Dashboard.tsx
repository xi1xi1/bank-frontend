        ...
        >
          <Row gutter={[16, 16]}>
            <Col xs={24} sm={12} md={6}>
              <Statistic
                title="存款次数"
                value={userStats.thisMonth.depositCount}
            ...
            <Col xs={24} sm={12} md={6}>
              <Statistic
                title="取款次数"
                value={userStats.thisMonth.withdrawCount}
            ...
            <Col xs={24} sm={12} md={6}>
              <Statistic
                title="利息收入"
                value={userStats.thisMonth.interestEarned}
            ...
            <Col xs={24} sm={12} md={6}>
              <Statistic
                title="总交易次数"
                value={getMonthlyTransactionCount()}
                prefix={<HistoryOutlined style={{ color: '#13c2c2' }} />}
                suffix="次"
