    ...
    <Card>
      ...
      >
        ...
        <Alert
          ...
          description={
            <div>
              <div><strong>用户ID:</strong> {user.user_id}</div>
              ...
              {user.id_number && <div><strong>身份证号:</strong> {user.id_number}</div>}
            </div>
          }
          type="info"
          showIcon
    ...
    <div style={{ maxWidth: 600, margin: '0 auto', padding: '24px 0' }}>
      ...
      {step === 0 && (
        <Alert
          ...
          description={
            <div>
              <p><strong>银行卡号:</strong> 6228480012345678 (12位数字)</p>
              <p><strong>交易密码:</strong> 123456 (6位数字)</p>
              <p><strong>姓名:</strong> 张三 (中文) 或 John Smith (英文)</p>
              <p><strong>身份证号:</strong> 110101199001011234 (18位，最后一位可以是X)</p>
              <Divider />
              <p><strong>调试帮助:</strong></p>
              <p>1. 打开浏览器开发者工具（F12）</p>
              <p>2. 切换到Console面板</p>
              <p>3. 填写表单后点击"调试验证"按钮</p>
              <p>4. 查看控制台的详细验证信息</p>
            </div>
          }
          type="info"
